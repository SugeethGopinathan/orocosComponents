...
namespace cogimon {
    ...
    struct ControlModes{
            ...
            static constexpr const char* CartesianImpedanceCtrl = "CartesianImpedanceCtrl";
    };
    ...
    struct FeedbackModes {
        ...
        static constexpr const char* poseFeedback = "CartesianPose";
    };
    ...
    template <class T> class poseFeedback {
    public:
        poseFeedback() {
        }
